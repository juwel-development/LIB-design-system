...
[naming rule](./coding.md#naming)) — it is part of the public API, so a consumer can name the type
of a prop it forwards.
...
The last two rules are stated as checkable rules in the
