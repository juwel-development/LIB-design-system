...
// control's face, and the placeholder that follows it, are docs/adr/0004's (#90). Its size is that
// ADR's too (#92): `body` is the one role clearing the 16px below which iOS Safari zooms the
// viewport on focus, a floor published on --text-body because a re-pointed token can break it.
const input = cva(
